...
public class Toktok extends Fragment  {
    ...
    public void ShowPopup(){
        TextView txtclose;
        Button call_btn;
        mDialog.setContentView(R.layout.toktok_call);
        txtclose = (TextView) mDialog.findViewById(R.id.toktokcancel_btn);
        call_btn = (Button) mDialog.findViewById(R.id.toktokcall_btn);
        call_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent CallTo = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:055-753-3533"));
