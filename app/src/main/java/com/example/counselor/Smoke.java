...
public class Smoke extends Fragment  {
    ...
    public void ShowPopup(){
        TextView txtclose;
        Button call_btn;
        mDialog.setContentView(R.layout.smoke_call);
        txtclose = (TextView) mDialog.findViewById(R.id.smokecancel_btn);
        call_btn = (Button) mDialog.findViewById(R.id.smokecall_btn);
        call_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent CallTo = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:055-759-9030"));
