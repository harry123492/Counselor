...
public class Miso extends Fragment  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.miso, container, false);
    ...
    public void ShowPopup(){
        TextView txtclose;
        Button call_btn;
        mDialog.setContentView(R.layout.miso_call);
        txtclose = (TextView) mDialog.findViewById(R.id.misoincancel_btn);
        call_btn = (Button) mDialog.findViewById(R.id.misoincall_btn);
        call_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent CallTo = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:070-8628-0387"));
