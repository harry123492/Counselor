...
public class InMusic extends Fragment  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.inmusic, container, false);
    ...
    public void ShowPopup(){
        TextView txtclose;
        Button call_btn;
        mDialog.setContentView(R.layout.inmusic_call);
        txtclose = (TextView) mDialog.findViewById(R.id.inmusiccancel_btn);
        call_btn = (Button) mDialog.findViewById(R.id.inmusiccall_btn);
        call_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent CallTo = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:055-748-8589"));
