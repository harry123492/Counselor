...
public class CurrentPermission extends AppCompatActivity {
    private static final String TAG = CurrentPermission.class.getSimpleName();
    ...
    public static final long DEFAULT_LOCATION_REQUEST_INTERVAL = 20000L; // 20초
    public static final long DEFAULT_LOCATION_REQUEST_FAST_INTERVAL = 10000L; // 10초
    ...
    private void checkLocationSetting() {
        ...
        settingsClient.checkLocationSettings(builder.build()) // 17분
                .addOnSuccessListener(this, new OnSuccessListener<LocationSettingsResponse>() {
                    @Override
                    public void onSuccess(LocationSettingsResponse locationSettingsResponse) {
                        try {
                            fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(CurrentPermission.this);
        ...
        .addOnFailureListener(CurrentPermission.this, new OnFailureListener() {
            @Override
                ...
                switch (statusCode) {
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        try {
                            ...
                            rae.startResolutionForResult(CurrentPermission.this, GPS_UTIL_LOCATION_RESOLUTION_REQUEST_CODE);
    ...
    private LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            // 주기적으로 현재 위치를 확인하지 않으므로 remove
            fusedLocationProviderClient.removeLocationUpdates(locationCallback);

            Intent intent = new Intent(CurrentPermission.this, MainActivity.class);
