...
public class Jinju extends Fragment  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.jinju, container, false);
    ...
    public void ShowPopup(){
        ...
        txtclose = (TextView) mDialog.findViewById(R.id.jinjucancel_btn);
        call_btn = (Button) mDialog.findViewById(R.id.jinjucall_btn);
        call_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent CallTo = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:055-759-3590"));
