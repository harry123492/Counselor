...
public class Wee extends Fragment  {
    ...
    public void ShowPopup(){
        TextView txtclose;
        Button call_btn;
        mDialog.setContentView(R.layout.wee_call);
        txtclose = (TextView) mDialog.findViewById(R.id.weecancel_btn);
        call_btn = (Button) mDialog.findViewById(R.id.weecall_btn);
        call_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent CallTo = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:055-740-2091"));
